...
public class PainelMenu extends JPanel implements MouseListener
{
	...
	public void mouseClicked(MouseEvent e)
	{
		...
		else if(e.getSource() == produtos)
		{
			if(this.funcionario > 1)
				...
				JOptionPane.showMessageDialog(null, "VocÍ n„o tem permiss„o para ver isso.");
		}
	...
	public void mouseEntered(MouseEvent e)
	{
		...
		{
			PainelLegenda.AtualizaLegenda("Venda R√°pida, direto no balc√£o.");
		}
		...
		{
			PainelLegenda.AtualizaLegenda("Gerenciamento de funcion√°rios.");
		}
		...
		{
			PainelLegenda.AtualizaLegenda("Clientes que ainda n√£o pagaram.");
		}
	}
